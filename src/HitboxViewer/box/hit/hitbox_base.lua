...
---@return HitBoxBase?
function this:new(collidable, parent, resource_idx, set_idx, collidable_idx, log_entry)
...
function this:is_trail_disabled()
    ...
    local order = {
        ...
        config_hitboxes.hit_condition.trail_enable[self.log_entry.hit_condition],
...
function this:update_data()
    ...
    elseif config_mod.hitboxes.hit_condition.color_enable[self.log_entry.hit_condition] then
        self.color = config_mod.hitboxes.hit_condition.color[self.log_entry.hit_condition]

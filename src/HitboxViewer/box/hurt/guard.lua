...
function this:update_shape()
    ...
    self.shape_data.degrees = 360.0
    if self.parent.guard_type == mod_enum.guard_type.GUARD then
        self.shape_data.degrees = math.deg(self.parent.base:getGuardAngleRange())
    end

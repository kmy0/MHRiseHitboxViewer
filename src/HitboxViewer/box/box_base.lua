...
---@class (exact) RingShape : CylinderShape
---@field ring_radius number

---@alias ShapeData CylinderShape | BoxShape | SphereShape | SlicedCylinderShape | RingShape
...
function this:new(box_type, shape_type)
    ...
    elseif shape_type == mod_enum.shape.Donuts then
        ---@cast shape_data RingShape
        shape_data.pos_a = Vector3f.new(0, 0, 0)
        shape_data.pos_b = Vector3f.new(0, 0, 0)
        shape_data.radius = 0
        shape_data.ring_radius = 0
    end

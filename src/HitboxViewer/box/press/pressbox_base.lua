...
---@param push snow.PushBehavior
---@return PressBoxBase?
function this:new(collidable, parent, resource_idx, set_idx, collidable_idx, push)
    ...
    ---@cast o PressBoxBase
    setmetatable(o, self)
    o.press_level = e.get("snow.hit.HitWeight")[push:get_Weight()]

    local filter_info = collidable:get_FilterInfo()
    o.layer = e.get("snow.hit.HitManager.Layer")[filter_info:get_Layer()]

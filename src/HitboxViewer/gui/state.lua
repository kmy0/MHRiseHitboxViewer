...
local this = {
    combo = {
        ...
        mystery_state = combo:new(
            util_table.map_table(mod_enum.mystery_state, function(o)
                return mod_enum.mystery_state[o]
            end, function(o)
                return mod_enum.mystery_state[o]
            end),
            function(a, b)
            ...
            nil,
            function(key)
                return config.lang:tr("mod.combo_mystery_state." .. mod_enum.mystery_state[key])
            end
        ),
        element = combo:new(
